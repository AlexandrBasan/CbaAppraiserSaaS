class Apartment < ActiveRecord::Base
    ...
    CSV.generate(options) do |csv|
      ...
      column_header = [ "code_provision", "new_code", "account_number", "alt_account_number", "tip", "region",
                       "district", "type_settlement", "city", "street_type", "street_name",
                        "room_apartment", "area", "floor_area", "number_rooms", "storey",
                        "floors", "series_home", "district_number", "uah_market_value",
  ...
  def self.import(file)
    ...
    allowed_attributes = [ "code_provision","new_code","account_number","alt_account_number","tip","region","district","type_settlement","city","street_type","street_name","room_apartment","area","floor_area","number_rooms","storey","floors","series_home","district_number","uah_market_value","usd_market_value","euro_market_value"]
